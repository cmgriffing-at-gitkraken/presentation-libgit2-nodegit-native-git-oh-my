import{d as _,_ as u,y as h,b as a,e as t,x as s,A as c,F as f,Z as g,o as n,$ as v,l as x,g as b}from"../modules/vue-j0WrzVxv.js";import{u as y,h as N,c as m,b as k}from"../index-DLZ_9PsQ.js";import{N as w}from"./NoteDisplay-BhrqIxKH.js";import"../modules/shiki-CMYXqV5Q.js";const L={id:"page-root"},T={class:"m-4"},V={class:"mb-10"},B={class:"text-4xl font-bold mt-2"},D={class:"opacity-50"},H={class:"text-lg"},S={class:"font-bold flex gap-2"},A={class:"opacity-50"},C=t("div",{class:"flex-auto"},null,-1),F={key:0,class:"border-main mb-8"},M=_({__name:"print",setup($){const{slides:d,total:p}=y();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
